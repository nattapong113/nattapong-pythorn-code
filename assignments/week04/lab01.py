...
def personal_info_manager():
    ...
    person = ("Nattapong", 19, "Chonburi", "Thai")  # name, age, city, country
    hobbies = []

    while True:

        choice = input(" What do you want to do? (1:display, 2:add hobby, 3:remove habby, 4:edit age, 5:ex)")
        ...
        # append hobbies
            habbies = input("What is your new habbies: ")
